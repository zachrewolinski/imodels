...
#         """
#         # Transform data
#         train_blocked_data = self.transformer.transform(X, center=self.center,
#                                                   normalize=self.normalize)
#         self.n_features = train_blocked_data.n_blocks
       
        
#         if train_blocked_data.shape[1] != 0:
#             pass
