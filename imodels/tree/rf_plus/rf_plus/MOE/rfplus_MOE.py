...
class RandomForestPlusMOE(pl.LightningModule):
    ...
    def __init__(self,rfplus_model, input_dim, noise_epsilon = 1e-2, criterion = nn.MSELoss(), gate_epsilon = 1e-10, use_loo = True,
                train_experts = False, lr = 1e-4, loss_coef = 0.01, noisy_gating = False,k = None,test_metrics = None,):
    ...
    def validation_step(self,batch,batch_idx):
        ...
        if self.task == "classification":
            class_output = torch.round(output).long()
